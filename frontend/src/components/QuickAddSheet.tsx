...
import { postQuickExpense, fetchCategories } from "@/lib/api";
...
export function QuickAddSheet({ open, onClose, onLogged }: Props) {
  ...
  const [spendType, setSpendType] = useState<"PLANNED" | "IMPULSIVE" | null>(null);
          ...
          <div className="flex-1 p-6 overflow-y-auto">
            <AnimatePresence mode="wait">
              {step === "amount" && (
                ...
                >
                  <p className="text-[var(--text-secondary)] font-display text-sm mb-2">Amount</p>
