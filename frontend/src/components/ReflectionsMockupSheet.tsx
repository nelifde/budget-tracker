...
const EXAMPLE_PROMPTS = [
  {
    ...
    options: ["Fine, it was planned", "A bit guilty", "Anxious", "Relieved", "Not sure"],
  },
  {
    title: "Then",
        ...
        >
          <div className="p-6 pb-10">
            ...
            <p className="text-[var(--text-secondary)] font-display text-sm leading-relaxed mb-8">
              From time to time we'll ask you about a spend — how you felt and why. When we notice
              similar activity later, we'll gently remind you of that moment. No judgment, just you
              and your patterns.
            </p>
            ...
            <div className="space-y-4 mb-8">
              {EXAMPLE_PROMPTS.map((p, i) => (
                ...
                >
                  <p className="text-xs font-display text-[var(--text-secondary)] mb-1">{p.title}</p>
            ...
            <p className="text-[var(--text-secondary)] font-display text-xs mb-4">
              When we detect similar activity (e.g. same category, impulsive again), we might show:
            </p>
